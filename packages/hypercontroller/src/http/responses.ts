// taken from FoalTS https://raw.githubusercontent.com/FoalTS/foal/master/packages/core/src/core/http/http-responses.ts
...
export function isHttpResponseSuccess(obj: any): obj is HttpResponseSuccess {
  return (
    obj instanceof HttpResponseSuccess ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseSuccess === true)
  )
}
...
export function isHttpResponseCreated(obj: any): obj is HttpResponseCreated {
  return (
    obj instanceof HttpResponseCreated ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseCreated === true)
  )
}
 ...
 */
export function isHttpResponseNoContent(
  obj: any
): obj is HttpResponseNoContent {
  return (
    obj instanceof HttpResponseNoContent ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseNoContent === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseRedirection(
  obj: any
): obj is HttpResponseRedirection {
  return (
    obj instanceof HttpResponseRedirection ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseRedirection === true)
  )
}
 ...
 */
export function isHttpResponseMovedPermanently(
  obj: any
): obj is HttpResponseMovedPermanently {
  return (
    obj instanceof HttpResponseMovedPermanently ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseMovedPermanently === true)
  )
}
...
export function isHttpResponseRedirect(obj: any): obj is HttpResponseRedirect {
  return (
    obj instanceof HttpResponseRedirect ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseRedirect === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseClientError(
  obj: any
): obj is HttpResponseClientError {
  return (
    obj instanceof HttpResponseClientError ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseClientError === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseBadRequest(
  obj: any
): obj is HttpResponseBadRequest {
  return (
    obj instanceof HttpResponseBadRequest ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseBadRequest === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseUnauthorized(
  obj: any
): obj is HttpResponseUnauthorized {
  return (
    obj instanceof HttpResponseUnauthorized ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseUnauthorized === true)
  )
}
 ...
 */
export function isHttpResponseForbidden(
  obj: any
): obj is HttpResponseForbidden {
  return (
    obj instanceof HttpResponseForbidden ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseForbidden === true)
  )
}
...
export function isHttpResponseNotFound(obj: any): obj is HttpResponseNotFound {
  return (
    obj instanceof HttpResponseNotFound ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseNotFound === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseMethodNotAllowed(
  obj: any
): obj is HttpResponseMethodNotAllowed {
  return (
    obj instanceof HttpResponseMethodNotAllowed ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseMethodNotAllowed === true)
  )
}
...
export function isHttpResponseConflict(obj: any): obj is HttpResponseConflict {
  return (
    obj instanceof HttpResponseConflict ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseConflict === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseTooManyRequests(
  obj: any
): obj is HttpResponseTooManyRequests {
  return (
    obj instanceof HttpResponseTooManyRequests ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseTooManyRequests === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseServerError(
  obj: any
): obj is HttpResponseServerError {
  return (
    obj instanceof HttpResponseServerError ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseServerError === true)
  )
}
 ...
 */
export function isHttpResponseInternalServerError(
  obj: any
): obj is HttpResponseInternalServerError {
  return (
    obj instanceof HttpResponseInternalServerError ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseInternalServerError === true)
  )
}
 ...
 * False otherwise.
 */
export function isHttpResponseNotImplemented(
  obj: any
): obj is HttpResponseNotImplemented {
  return (
    obj instanceof HttpResponseNotImplemented ||
    (typeof obj === 'object' &&
      obj !== null &&
      obj.isHttpResponseNotImplemented === true)
  )
}
